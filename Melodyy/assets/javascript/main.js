...
const app = {
    ...
    songsData : [
        {
            background: './assets/img/songs/00.jpg',
            name: 'Chúng ta của tương lai',
            singer: 'Sơn Tùng MTP',
            pathSong: './assets/music/list-song/00.mp3',
            duration : '04:35',
        },
        {
            background: "./assets/img/songs/11.jpg",
      name: "Thiên Lý ơi",
      singer: "JACK - J97 ",
      ...
      singer: "PHAN MẠNH QUỲNH | (OST phim MAI)",
      pathSong: "./assets/music/list-song/22.mp3",
      duration: "04:22",
        },
        {
            background: "./assets/img/songs/44.jpg",
      name: "Dân Chơi Sao Phải Khóc",
      singer: "Andree Right Hand - RHYDER, WOKEUP",
      pathSong: "./assets/music/list-song/44.mp3",
      duration: "03:58",
        },
        {
            background: "./assets/img/songs/55.jpg",
      name: "BUỒN HAY VUI ",
      singer: "VSOUL x MCK x Obito x Ronboogz x Boyzed",
      pathSong: "./assets/music/list-song/55.mp3",
      duration: "04:51",
        },
        {
        ...
        themeItems.forEach((themeItem, index) => {
            themeItem.onclick = function() {
                if (index == 0) {
                    ...
                    $('.header').style.backgroundColor = `var(--header-color-${backgroundIndex})`;
                    $('.header').style.boxShadow = '0 3px 5px rgba(0,0,0,0.1)';
                    $('.main').style.backgroundImage = 'url(./img/111.png)';
                    $('.main-music-control').style.backgroundImage = '';
                    $('.main-music-control').style.backgroundColor = '#000000';
                    ...
                    $('.header').style.boxShadow = '0 3px 5px rgba(0,0,0,0.1)';
                    $('.main').style.backgroundImage = 'url(./assets/img/background-theme/modalThemes/modalTheme1/theme4.jpg)';
                    $('.main-music-control').style.backgroundImage = 'none';
                    $('.main-music-control').style.backgroundColor = '#000000';
                    $('.mobile-tab').style.backgroundColor = '#202020';
                    $('.sidebar__add-playlist').style.backgroundColor = '#000000';
                    $('.sidebar__add-playlist').style.borderTop = 'rgba(255, 255, 255, 0.1);';
            ...
            return `
                ...
                <li class="songs-item js__song-item0 ${index == this.currentIndex ? 'songs-item--active' : ''} " data-index="${index}">
                    ...
                    <div class="songs-item-right mobile-hiden ">
                        ...
                        <span class="songs-item-right-more js__main-color" onclick="increset()"><i class="fas fa-download"></i></span>
                    </div>
                </li>`
        })
    ...
    handleEvents: function () {
        ...
        audio.onended = function () {
            let numberElement = document.getElementById("counter_num1");
